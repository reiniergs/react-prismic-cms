...
/**
* The QueryDayOfMonthBefore checks that the value in the path
* is before the day of the month passed.
*/
export default function QueryDayOfMonthBefore(props) {
    return <Query {...props} predicate="dayOfMonthBefore" />;
}

QueryDayOfMonthBefore.propTypes = {
    ...
    /** Defines the value that the query is looking for. It is a number representing
...
QueryDayOfMonthBefore.defaultProps = {
    value: 1,
    component: undefined,
    after: undefined,
    fetch: undefined,
