...
/**
* The QueryMonthAfter checks that the value in the path occurs in any month after
* the value passed.
*/
...
QueryMonthAfter.propTypes = {
     ...
     * the month. e.g('january', 'jan', or 1) */
