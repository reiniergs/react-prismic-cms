...
QueryDateBetween.propTypes = {
    ...
    /** Defines the value that the query is looking for. Accept an object value with startDate
     * and endDate keys. Each one must be a Date object, a timestamp
